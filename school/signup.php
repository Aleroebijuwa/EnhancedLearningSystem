...
$sql = "INSERT INTO users (Sn, UserId , Name, Gender, Phone,Email, StreetAddress,City,Password,Country,level,date )
VALUES ('','$UserId','$Name','$Gender', '$Phone','$Email','$StreetAddress','$City','$Password','$Country','stage1','$date')";
