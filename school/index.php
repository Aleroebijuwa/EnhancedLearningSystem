    ...
    <div class="mdk-header-layout js-mdk-header-layout">
        ...
        <div id="header" >
            <div class="mdk-header__bg">
                <div> <img src="assets/images/b2.jpg" width="100%" height="450px"></div>
            </div>
                ...
                <div class="navbar navbar-expand navbar-dark-dodger-blue bg-transparent will-fade-background" id="default-navbar" data-primary>
                    ...
                    <ul class="nav navbar-nav ml-auto mr-0">
                        <li class="nav-item">
                            ...
                            <a href="../../index.php" class="btn btn-outline-white">Back to website Home Page</a> &nbsp;&nbsp;&nbsp; <a href="signup.php" class="btn btn-outline-white">Register to school</a>
                        </li>
                    </ul>
                </div>

                <div class="hero container page__container text-center text-md-left py-112pt">
                    <h1 class="text-white text-shadow">Welcome to our Mission School  </h1>

                    <a href="login.php" class="btn btn-lg btn-white btn--raised mb-16pt">Login as a Student</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="../adminlogin.php" class="btn btn-lg btn-white btn--raised mb-16pt">Login as a Teacher</a>
