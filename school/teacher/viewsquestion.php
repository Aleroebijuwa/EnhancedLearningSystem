...
$UserId = $_REQUEST['UserId'];
						...
						$queryg = "SELECT * FROM users WHERE UserId = '$UserId'";
...
$UserId = $_REQUEST['UserId'];
						...
						$queryb = "SELECT * FROM schoolquestions WHERE UserId = '$UserId'";
              ...
              <div class="page-section">
                <div class="container page__container">
                    ...
                    <div class="d-flex align-items-center mb-heading">
                        <h4 class="m-0">Student Name: <font color="red"><?php echo $Name; ?></font></h4>
                    ...
                    <div class="border-top">
                        ...
                        <h2 class="m-0"><?php echo $ItemTitle; ?></h2>
                    </div>

                    <h6><p class="card-title"><?php echo $Question; ?></p></h6>
                            </div>
...
$sql="UPDATE schoolquestions SET Reply = '$Reply',date2 = '$date2' WHERE UserId = '$UserId'";
  ...
  header('Location: '.'thanks.php');
											...
											?>
                                        <form method="post" action="viewquestion.php" enctype="multipart/form-data">
								
                                   
									
					         <div class="form-group">
					  <br>
								<label class="form-label" for="Reply">Reply Question:</label>
                      <textarea name="Reply" cols="60" rows="10" id="Reply" class="form-control"></textarea>
					  </div>
					  
								
								<input class="btn btn-primary" type="submit" name="submit" id="submit" value="Reply Question">
