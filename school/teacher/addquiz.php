...
<?php
	...
	?>
            ...
            <div class="card">
              <div class="card-body">
                <h6 class="card-title">Add Quiz Question</h6>
	...
	//$report_file = $rowb['report_file']; ?>
                      <tr>
                        ...
                        <td>
						<div class="col-auto">
                            <a href="addquiz2.php?CourseId=<?php echo $CourseId; ?>" class="btn btn-outline-secondary" onClick="return check_deletion()">Add Quiz</a>
                        </div>
						</td>
                      </tr>
					  <?php	} ?>
