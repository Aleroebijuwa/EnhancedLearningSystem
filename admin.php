...
<header>
    <div class="headerwrapper">
       <span class="span-header">Using computing threshold to reduce information overload for student learning system</span>
    ...
    <div class="mainwrapper">
        <div class="leftpanel">
            ...
            <ul class="nav nav-pills nav-stacked">
			   ...
			   <li class=""><a href="autogenerate.php"><i class="fa fa-wrench"></i> <span>Select an optimisation Technique</span></a>
