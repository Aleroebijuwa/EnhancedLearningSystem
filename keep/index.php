...
<head>
        ...
        <title>NYSC Primary Place of Assignment Allocation Management System</title>
        ...
        <section>
            ...
            <div class="panel panel-signin">
                <div class="panel-body">
                    ...
                    <br />
                    <h4 class="text-center mb5">NYSC PRIMARY PLACE OF ASSIGNMENT ALLOCATION MANAGEMENT SYSTEM</h4>
                    ...
                    <form action="index.php" method="post">
                        ...
                        <div class="clearfix">
                            ...
                            <div class="pull-right">
                                <button type="submit" class="btn btn-success" name="submit" >Super Admin Sign In <i class="fa fa-angle-right ml5"></i></button>
                            </div>
...
<div class="ckbox ckbox-primary mt10">
                                    ...
                                    <a href="delete.php">New Employer, Start Here</a>
                ...
                <div class="panel-footer">
                    <a href="signup.html" class="btn btn-timi btn-block">Copyright 2021 </a>
                </div><!-- panel-footer -->
            </div><!-- panel -->
