...
$query = "SELECT * FROM demerit WHERE Name ='$oname' AND Description = '$description'";
...
$querye = "INSERT INTO demerit VALUES (0,'$oname', '$description', '$point')";
...
echo 'Demerit registration Successful </br></br></br></br></br>';
...
echo 'Thanks <a href="registerdemerit.php">Register another demerit</a></br>';
        ...
        <div class="mainpanel">
            ...
            <div class="contentpanel">
                <div class="panel panel-babcock">
                    <div  class="panel-heading">Demerit
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12">
                                <form class="form-horizontal" action="registerdemerit.php" method="post">
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-2 control-label">Demerit Name</label>
                                        <div class="col-md-6">
                                            <input type="text" class="form-control" id="name" placeholder="Demerit" name="oname">
                                        </div>
                                    </div>
									...
									<div class="form-group">
                                        <label for="inputEmail3" class="col-sm-2 control-label">Demerit points</label>
                                        <div class="col-md-6">
                                            <input type="Number" class="form-control" id="name" placeholder="Point" name="point">
                                        </div>
                                    </div>
