...
$query = "SELECT * FROM property WHERE Generatedtag = '$tag'";
...
$name = $row['Name'];	
	...
	//if($role =='Admission'){
		...
		echo '<h1>IDENTITY OF THE OWNER OF ITEM TAGGED '.$tag.'</h1></br>';
		...
		echo '<h3>Serial No : <i>'.$row['Serial'].'</i> Phone : <i>'.$row['Phone'].'</i>  Email : <i>'.$row['Email'].'</i></h3></br></br>';
                ...
                <div class="panel-body">
                    ...
                    <form action="search.php" method="post">
                        <div class="input-group mb15">
                            ...
                            <input type="text" class="form-control" placeholder="Generated Tag" name="tag">
                        </div><!-- input-group -->
