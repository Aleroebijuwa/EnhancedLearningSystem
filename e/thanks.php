        ...
        <div class="mdk-header-layout__content page-content ">
            ...
            <div class="page-section">
                <div class="container page__container">
                    <form action="" class="col-md-8 p-0 mx-auto">

                        
                            <div class="list-group-item">
                                       <label class="col-sm-12" align="center"><H6 align="center" >Thank you <font size="4px"><?php echo $Name?></font> for Registaring for a bible study series on Spring of Life Outreach Ministry.<br>
									   Kindly Login with your Email: <font size="4px"><?php echo $Email?></font> and Password</H6></label>
