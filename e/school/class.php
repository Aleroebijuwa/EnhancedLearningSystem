...
// while ($row=mysqli_fetch_array($result)){
	...
	///////////////////////////////////////////////////////////
	$queryc = "SELECT* FROM courselist WHERE level = '$level'  ";
            ...
            <div class="navbar navbar-expand pr-0 navbar-light border-bottom-2" id="default-navbar" data-primary>
                ...
                <span class="d-none d-md-flex align-items-center mr-16pt">
                    ...
                    <small class="flex d-flex flex-column">
                        <strong class="navbar-text-100"><h5>You are welcome  <?php echo $Name; ?>  to Mission School</h5></strong>
                    </small>
                </span>
                ...
                <div class="container page__container d-flex flex-column flex-md-row align-items-center text-center text-sm-left">
                    <div class="flex d-flex flex-column flex-sm-row align-items-center mb-24pt mb-md-0">
                        ...
                        <div class="mb-24pt mb-sm-0 mr-sm-24pt">
                            <h2 class="mb-0">Mission School Learning Paths</h2>
...
$sql ="SELECT count(ItemId) AS total FROM studies WHERE CourseId = '$CourseId'";
...
?>
                    ...
                    <div class="row" role="tablist">
                        <div class="col-auto">
                            <a href="courses.php" class="btn btn-outline-secondary">school Courses</a>
                        </div>
                    </div>
                ...
                <div class="container page__container">
					...
					<?php echo $dimg; ?>
                        ...
                        <div class="card-body d-flex align-items-center justify-content-center fullbleed">
                            <div>
                                <h2 class="text-white mb-16pt"><?php echo $CourseTitle; ?></h2>
								...
								<a href="studentschoollesson.php?CourseId=<?php echo $CourseId;?>" class="btn btn-primary mr-8pt">Resume</a>
                    ...
                    <div class="d-flex flex-wrap align-items-start">
                        <div class="d-flex align-items-center mr-24pt">
                            ...
                            <div class="flex">
                                <a class="card-title" href="paths.php"><?php echo $CourseTitle; ?></a>
                                <p class="lh-1 mb-0">
                                    <span class="text-50 small">with</span>
                                    <span class="text-50 small"><?php echo $teacherid; ?></span>
                                </p>
                            </div>
                        </div>
      ...
      <a 
        ...
        class="text-underline ml-sm-auto">All my learning paths</a>
                    ...
                    <div class="page-separator">
                        <div class="page-separator__text">Your School Learning Paths</div>
                    </div>
					...
					<?php
$queryo = "SELECT* FROM courselist WHERE level = '$level'  ";
//$queryc = "SELECT * FROM courselist WHERE level = '$level1' "; 
//"SELECT * FROM bible_studies  WHERE bibleId = '$bibleId'";
	...
	$CourseId = $rowo['CourseId']; 
	$CourseTitle = $rowo['CourseTitle']; 
	$level = $rowo['level']; 
	$CourseDis = $rowo['CourseDis'];
	//$ItemId = $rowo['ItemId'];
	//$report_type_id = $rowb['report_type_id'];
	//$teacherid =  $rowb['teacherid1'];
                        ...
                        <div class="col-lg-3 card-group-row__col">
                            ...
                            <div class="card card-sm card--elevated p-relative o-hidden overlay overlay--primary-dodger-blue js-overlay card-group-row__card" data-toggle="popover" data-trigger="click">
                                ...
                                <div class="card-body flex">
                                    <div class="d-flex">
                                        <div class="flex">
                                            <a class="card-title" href="student-take-course.html"><?php echo $CourseTitle; ?></a>
                                            <small class="text-50 font-weight-bold mb-4pt">You are in<?php echo $level; ?></small>
                                        </div>
                            ...
                            <div class="popoverContainer d-none">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <div class="card-title mb-0"><?php echo $CourseTitle; ?></div>
                                        <p class="lh-1 mb-0">
                                            <span class="text-black-50 small">You are in</span>
                                            <span class="text-black-50 small font-weight-bold"><?php echo $level; ?></span>
                                        </p>
                                    </div>
                                </div>

                                <p class="my-16pt text-black-70"><?php echo $CourseDis; ?></p>
