    ...
    <div class="mdk-header-layout js-mdk-header-layout">
                ...
                <div class="navbar navbar-expand navbar-dark-dodger-blue bg-transparent will-fade-background" id="default-navbar" data-primary>
                    ...
                    <ul class="nav navbar-nav ml-auto mr-0">
                        <li class="nav-item">
                            ...
                            <a href="index.php" class="btn btn-outline-white">Back to website Home Page</a> &nbsp;&nbsp;&nbsp; <a href="signup.php" class="btn btn-outline-white">Register As Student</a>
                        </li>
                    </ul>
                </div>

                <div class="hero container page__container text-center text-md-left py-112pt">
                    <h1 class="text-white text-shadow">Using computing threshold to reduce information overload for student learning system  </h1>

                    <a href="login.php" class="btn btn-lg btn-white btn--raised mb-16pt">Login as a Student</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <div class="js-fix-footer2 bg-white border-top-2">
			...
			<img class="brand-icon" src="../../img/resources/logo-2.png" alt="Luma"> 
                    ...
                    <p class="text-50 small mt-n1 mb-0">Copyright © Ebijuwa stephanie and Nicholas Anjola<?php echo date("Y"); ?> &copy; All rights reserved.</p>
				</div>
            </div>
