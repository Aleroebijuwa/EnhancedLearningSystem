...
<head>
    ...
    <title>Pre university System</title>
        ...
        <div class="mdk-drawer-layout__content page-content">
            ...
            <div class="navbar navbar-expand pr-0 navbar-light border-bottom-2" id="default-navbar" data-primary>
                ...
                <a href="index.html" class="navbar-brand mr-16pt d-lg-none">
                    ...
                    <span class="d-none d-lg-block">Pre university System</span>
                </a>
                ...
                <span class="d-none d-md-flex align-items-center mr-16pt">
                    ...
                    <small class="flex d-flex flex-column">
                        <strong class="navbar-text-100"><h5>You are welcome to Pre university System <?php echo $user; ?>  </h5></strong>
                    </small>
                </span>
                ...
                <div class="container page__container d-flex flex-column flex-md-row align-items-center text-center text-sm-left">
                    <div class="flex d-flex flex-column flex-sm-row align-items-center mb-24pt mb-md-0">
                        ...
                        <div class="mb-24pt mb-sm-0 mr-sm-24pt">
                            <h2 class="mb-0">Pre university System</h2>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                <div class="card-header d-flex align-items-center">
                                    <div class="h2 mb-0 mr-3"> Student Personnal detail</div>
                                    <div class="flex">
                                    </div>
                                ...
                                <div class="card-body p-24pt">
									...
									<p class="card-title">Stage in school: <font color ="red"><?php echo 'Pre Uni'; ?></font></p><br>
                                     <p class="card-title">Name: <font color ="red"><?php echo $user; ?></font></p><br>
<p class="card-title">Email: <font color ="red"><?php echo $emaile; ?></font></p>	<br>
<p class="card-title">Phone No: <font color ="red"><?php echo $phonee;?></font></p><br>	
<p class="card-title">Status: <font color ="red"><?php echo $status; ?></font></p><br>	
<p class="card-title">Program: <font color ="red"><?php echo $program; ?></font></p><br>
                    ...
                    <div class="row mb-lg-16pt">
                        ...
                        <div class="col-lg-9 mb-12pt mb-sm-0">
                            <div class="page-separator">
                                <div class="page-separator__text">Courses you are to take in this level</div>
                            </div>

					<?php
						$queryb = "SELECT * FROM courselist WHERE level = '$level1' ";
	...
	$teacherid = $rowb['teacherid'];
	$CourseDis = $rowb['CourseDis'];
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="flex">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex">
                                                    <div class="card-title"><?php echo $CourseTitle ?></div>
                            ...
                            <div class="popoverContainer d-none">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <div class="card-title"><?php echo $CourseTitle; ?></div>
                                        <p class="text-black-50 d-flex lh-1 mb-0 small"><?php echo $teacherid; ?></p>
										
                                    </div>
                                </div>

                                <p class="mt-16pt text-black-70"> <?php echo $CourseDis; ?></p>
...
<a href="class.php" class="btn btn-primary mr-8pt">Resume</a>
                        </div>
            ...
            <div class="js-fix-footer2 bg-white border-top-2">
                <div class="container page__container page-section d-flex flex-column">
                  ...
                  <img class="brand-icon" src="../../img/resources/logo-2.png" alt="Luma"> 
                    ...
                    <p class="text-50 small mt-n1 mb-0">Copyright &copy; Pre university System<?php echo date("Y"); ?>  All rights reserved.</p>
				</div>
            </div>
            ...
            <div class="mdk-drawer__content">
                <div class="sidebar sidebar-dark-dodger-blue sidebar-left" data-perfect-scrollbar>
                    ...
                    <a href="index.php" class="sidebar-brand ">
                        ...
                        <span>Pre university System </span>
                    </a>
