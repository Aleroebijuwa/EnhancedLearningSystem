...
//$temppathreport_file = $_FILES['report_file']['tmp_name'];



//$filenamereport_file = '../../photos/'. $report_file;



//move_uploaded_file($temppathreport_file, $filenamereport_file);
	
	$sql="UPDATE `adminuser` SET `rank` = '$rank', `gender` = '$gender', `email` = '$email', `asp` = '$asp', `teacherprofile` = '$teacherprofile',  `date` = '$date' WHERE `adminuser`.`teacherid` = '$teacherid1'";
	//$sql="UPDATE adminuser SET f_name = '$f_name', l_name = '$l_name', user_name = '$user_name', email = '$email, password = '$password', c_password = '$c_password', regulatory_id = '$regulatory_id, category_id = '$category_id', date= '$date' WHERE adminuser_id = '$adminuser_idd'";
	echo $sql;
...
<div class="container page__container page-section">
				...
				<div class="col-lg-8">
				<p><h4><?php echo $teachername;?></h4></p>
                <form method="post" action="edittearcherprofile.php">
								<div class="form-group">
								<label class="form-label" for="name">Rank:</label>
								<label for="rank" ></label>
                            <select name="rank" class="form-control"  id="rank" >
							<option value=""><?php echo $rank;?></option>
							 <option value="-">-</option>
							...
							<div class="form-group">
                                    ...
                                    <input name="email" id="email" type="text" class="form-control" value="<?php echo $email;?>" placeholder="Course Title ...">
                                </div>
								<div class="form-group">
                                    <label class="form-label" for="asp">Area of Specialization:</label>
                                    <input name="asp" id="asp" type="text" class="form-control" value="<?php echo $asp;?>" placeholder="Course Title ...">
                                </div>
								<div class="form-group">
								<label class="form-label" for="teacherprofile">Teachers Profile:</label>
                      <textarea name="teacherprofile" cols="60" rows="10" id="teacherprofile" class="form-control"><?php echo $teacherprofile;?></textarea>
					  </div>
								<div class="form-group">
								  <label class="form-label" for="teacherimage">Teachers Image:</label><br>
                                  <input type="file" name="teacherimage" id="teacherimage"></td>
                                </div>
