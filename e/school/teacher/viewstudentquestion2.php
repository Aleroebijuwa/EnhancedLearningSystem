...
$level = $_REQUEST['level'];
						...
						$queryb = "SELECT * FROM users WHERE level = '$level'";
	...
	//$report_file = $rowb['report_file']; ?>
                      <tr>
                        ...
                        <td>
						<div class="col-auto">
                            <a href="viewsquestion.php?UserId=<?php echo $UserId; ?>" class="btn btn-outline-secondary" onClick="return check_deletion()">view students Questions</a>
                        </div>
						</td>
                      </tr>
					  <?php	} ?>
