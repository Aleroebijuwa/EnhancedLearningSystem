...
$sql = "INSERT INTO quiz (sn,CourseId,moduleid,Instr,Quest,Opt1,Opt2,Opt3,Opt4,Corr,date )
VALUES ('','$CourseId','$moduleid','$Instr','$Quest','$Opt1','$Opt2','$Opt3','$Opt4','$Corr','$date')";
                ...
                <div class="container page__container d-flex flex-column flex-md-row align-items-center text-center text-sm-left">
                    <div class="flex d-flex flex-column flex-sm-row align-items-center mb-24pt mb-md-0">
                        ...
                        <div class="mb-24pt mb-sm-0 mr-sm-24pt">
                            <h2 class="mb-0">Add Quiz Question</h2>
  ...
  <tr>
	...
	<td><h4></h4></td>
            ...
            <div class="container page__container page-section">
				...
				<div class="col-lg-8">
                <form method="post" action="addquiz2.php">
	...
	?>
                      ...
                      <textarea name="Quest" cols="60" rows="10" id="Instr" class="form-control"></textarea>
							...
							<div class="form-group">
								...
								<input class="btn btn-primary" type="submit" name="submit" id="submit" value="Add Quiz">
            ...
            <div class="js-fix-footer2 bg-white border-top-2">
                <div class="container page__container page-section d-flex flex-column">
                    <p class="text-70 brand mb-24pt">
                        <img class="brand-icon" src="assets/images/logo/black-70%402x.png" width="30" alt="Luma"> CRS E-Learning
                    </p>
                    <p class="measure-lead-max text-50 small mr-8pt">CRS E-Learning is a beautifully crafted user interface for modern Education Platforms, including Courses & Tutorials, Video Lessons, Student and Teacher Dashboard, Curriculum Management, Earnings and Reporting, ERP, HR, CMS, Tasks, Projects, eCommerce and more.</p>
