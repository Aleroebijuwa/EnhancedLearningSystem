                ...
                <div class="container page__container d-flex flex-column flex-md-row align-items-center text-center text-sm-left">
                    <div class="flex d-flex flex-column flex-sm-row align-items-center mb-24pt mb-md-0">
                        ...
                        <div class="mb-24pt mb-sm-0 mr-sm-24pt">
                            <h2 class="mb-0">Mission School Dashboard</h2>
            ...
            <div class="container page__container">
                <div class="page-section">
                    ...
                    <div class="page-separator">
                        <div class="page-separator__text">Courses for all stages in the mission school</div>
                    </div>
                    ...
                    <div class="row mb-lg-16pt">
                        ...
                        <div class="col-lg-9 mb-12pt mb-sm-0">
                            <div class="page-separator">
                                <div class="page-separator__text">Courses in stages 1</div>
                            </div>

					<?php
						$queryb = "SELECT * FROM courselist where level='stage1'";
...
<?php } ?>
					...
					<div class="row mb-lg-16pt">
                        ...
                        <div class="col-lg-9 mb-12pt mb-sm-0">
                            <div class="page-separator">
                                <div class="page-separator__text">Courses in stages 2</div>
                            </div>

					<?php
						$queryc = "SELECT * FROM courselist where level='stage2'";
...
<?php } ?>
					...
					<div class="row mb-lg-16pt">
                        ...
                        <div class="col-lg-9 mb-12pt mb-sm-0">
                            <div class="page-separator">
                                <div class="page-separator__text">Courses in stages 3</div>
                            </div>

					<?php
						$queryd = "SELECT * FROM courselist where level='stage3'";
...
<?php } ?>
					...
					<div class="row mb-lg-16pt">
                        ...
                        <div class="col-lg-9 mb-12pt mb-sm-0">
                            <div class="page-separator">
                                <div class="page-separator__text">Courses in stages 4</div>
                            </div>

					<?php
						$querye = "SELECT * FROM courselist where level='stage4'";
	...
	//$insurance_id = $row['insurance_id'];
	$cps = $cps +1;
	$CourseId = $rowe['CourseId']; 
	$CourseTitle = $rowe['CourseTitle'];
	$teacherid = $rowe['teacherid'];
	//$report_type_id = $rowb['report_type_id'];
	//$teacherid =  $rowb['teacherid1'];
