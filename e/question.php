...
if (!isset($_SESSION['total'])){
	...
	//&bstudyId=<?php echo $bstudyId;?&bibleId=<?php echo $bibleId;?
	
	$query1 = "select * from `questions` where question_number > $sn order by question_number asc limit 1";
...
$result1 = mysqli_query($dbc, $query1);
	...
	$sn = $row['question_number'];
	$bstudyId = $row['bstudyId'];
	$bibleId = $row['bibleId'];
	$_SESSION['bstudyId'] = $bstudyId;
	$_SESSION['bibleId'] = $bibleId;
	$_SESSION['sn'] = $sn;
	
	
	$query2 = "select * from `choices` where question_number = $sn";
...
<body class="layout-sticky-subnav layout-default ">
            ...
            <div class="page-section">
                <div class="container page__container">
                            ...
                            <div class="list-group-item">
                                       <label class="col-sm-12" align="center"><?php echo $count; 
		//$number; ?> of <?php echo $total1; ?></H6></label>
		<p class="question">
	...
	<form method="post" action="process.php">
		 ...
		 <h6><li><input name="choice" type="radio" value="<?php echo $row2['id']; ?>" />
		 <?php echo $row2['choice']; ?></h6>
		</li>
		<?php endwhile; ?>
	      </ul>
		  <input type="hidden" name="number" class="btn btn-primary"  value="<?php echo $question_number; ?>" />
    ...
    <span class="sidebar-menu-text">Chips</span>
                    ...
                    <li class="sidebar-menu-item">
                        ...
                        <ul class="sidebar-submenu collapse sm-indent" id="layouts_menu">
                            ...
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="mini-signup-payment.html">
                                    <span class="sidebar-menu-text">Mini</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="mini-secondary-signup-payment.html">
                            ...
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="boxed-signup-payment.html">
                                    <span class="sidebar-menu-text">Boxed</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="sticky-signup-payment.html">
