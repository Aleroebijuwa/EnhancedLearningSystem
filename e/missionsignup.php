                    ...
                    <div class="row">
                        <div class="col-md-6 mb-24pt mb-md-0">
							...
							<div class="form-group">
								<label class="form-label" for="name">Select Type of Studies:</label>
								<label for="Gender"></label>
                            <select name="Studies" class="form-control"  id="gender">
                              <option value="Male">Mission School</option>
                              <option value="Female">Bible Study</option>
                            </select>
							</div>
								<div class="form-group">
