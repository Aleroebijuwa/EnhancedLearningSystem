...
<div class="lesson__progress-bar"></div>


<div class="lesson__number"><div>Content<br>Page</div></div><h1 class="lesson__heading">Content Table</h1><div class="lesson__panel"><div class="lesson__step-body"><?php
$bibleId = $_REQUEST['bibleId'];
...
$LessonsTitle = $rowb['LessonsTitle'];	
 ...
 ?><a  href="biblestudylessoninfo.php?bstudyId=<?php echo $bstudyId;?>&bibleId=<?php echo $bibleId;?>"><?php echo $bstudyId;?>: <?php echo $LessonsTitle; ?></a> <br> 
<?php } ?></div></div></div>
<?php
$bibleId = $_REQUEST['bibleId'];
...
<a href="biblestudylessoninfo.php?bstudyId=<?php echo $bstudyId;?>&bibleId=<?php echo $bibleId;?>" class="lesson__button">Start</a>
