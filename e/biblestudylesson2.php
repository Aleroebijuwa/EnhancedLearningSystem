                ...
                <div class="mdk-box__content">
                    <div class="hero py-64pt text-center text-sm-left">
                        <div class="container page__container">
                            <h1 class="text-white"><?php echo $biblestudiesname; ?></h1>
                            <p class="lead text-white-50 measure-hero-lead mb-24pt"><?php echo $info; ?></p>
                            <a href="biblestudylessoninfo.php?bstudyId=<?php echo $bstudyId;?>&bibleId=<?php echo $bibleId;?>" class="btn btn-white">Resume course</a>
                                ...
                                <li class="nav-item navbar-list__item">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="media-body">
                                            <a class="card-title m-0" href="teacher-profile.html"><?php echo $author; ?></a>
                    ...
                    <div class="col-lg-7">
                        <div class="border-left-2 page-section pl-32pt">
                            ...
                            <div class="d-flex align-items-center page-num-container">
                                ...
                                <h4>Getting Started With <?php echo $biblestudiesname; ?></h4>
                            </div>
                                ...
                                <ul class="accordion accordion--boxed js-accordion mb-0" id="toc-1">
                                    <li class="accordion__item open">
                                        ...
                                        <a class="accordion__toggle" data-toggle="collapse" data-parent="#toc-1" href="#toc-content-1">
                                            <span class="flex">Table of contents</span>
                                        ...
                                        <div class="accordion__menu">
                                            <ul class="list-unstyled collapse show" id="toc-content-1">
                                                <li class="accordion__menu-link">
                                                    ...
                                                    <a class="flex" href="biblestudylessoninfo.php?bstudyId=<?php echo $bstudyId;?>&bibleId=<?php echo $bibleId;?>"><?php echo $LessonsTitle; ?></a>
                    ...
                    <div class="col-lg-5 page-nav">
                        <div class="page-section">
                            ...
                            <nav class="nav page-nav__menu">
                                <a class="nav-link active" href="#"><?php echo $info; ?></a>
                            </nav>
                        </div>
                    </div>
                </div>
...
while ($rowb=mysqli_fetch_array($resultb)){
 ...
 ?>	
 <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="biblestudylessoninfo.php?bstudyId=<?php echo $bstudyId;?>&bibleId=<?php echo $bibleId;?>">
                                <span class="material-icons sidebar-menu-icon sidebar-menu-icon--left">dvr</span>
                                <span class="sidebar-menu-text"><?php echo $bstudyId; ?></span>
                            </a>
                        </li>
...
<?php } ?>
                        ...
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="quiz_result.php">
