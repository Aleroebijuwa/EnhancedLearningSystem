...
<?php } ?>
                            ...
                            <div id="carouselExampleFade" class="">
...
//"SELECT * FROM bible_studies  WHERE bibleId = '$bibleId'";
 ...
 ?>
                            <div class="card js-overlay card-sm overlay--primary-dodger-blue stack stack--1 mb-16pt" data-toggle="popover" data-trigger="">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="flex">
                                            <div class="d-flex align-items-center">
												...
												<a href="paths.php?bibleId=<?php echo $bibleId;?>" class="btn btn-primary mr-8pt">Resume</a>
                                            </div>
                            ...
                            <div class="popoverContainer d-none">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <div class="card-title"><?php echo $biblestudiesname; ?></div>
                                        <p class="text-black-50 d-flex lh-1 mb-0 small"></p>
