            ...
            <div class="mdk-header__content justify-content-center">
                ...
                <div class="navbar navbar-expand navbar-dark-dodger-blue bg-transparent will-fade-background" id="default-navbar" data-primary>
                    ...
                    <ul class="nav navbar-nav ml-auto mr-0">
                        <li class="nav-item">
                            <a href="student_dashboard.php" class="btn btn-outline-white">Back To Home Page</a>
                        </li>
                    </ul>
                </div>
        ...
        <div class="mdk-header-layout__content page-content ">
            ...
            <div class="page-section container page__container">
                <div class="col-lg-12 p-0 mx-auto">
                    <div class="row">
                        <div class="col-md-8 mb-24pt mb-md-0">
					<div class="list-group-item">
                                       <label class="col-sm-12" align="center"><H6 align="center" >Thank you  for Registaring for a bible study series on Spring of Life Outreach Ministry.
									   Kindly click on the enroll button to enroll.</H6></label>
							...
							<input name="UserId" id="UserId" type="hidden"  class="form-control" value="<?php echo $UserId; ?>"> <br>
								
								<input class="btn btn-primary" type="submit" name="submit" id="submit" value="Enroll">
                            </form>
                        </div>
