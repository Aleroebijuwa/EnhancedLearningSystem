...
// while ($row=mysqli_fetch_array($result)){
	...
	$queryc = "SELECT* FROM bible_studies WHERE bibleId = '$bibleId'"; 
...
<div class="masthead"><div class="container-fluid"><img src="assets/logo-2.png" ><div class="site-nav"></div><a class="nav-trigger"><span class="nav-trigger__box"><span class="nav-trigger__inner"></span></span></a>You are welcome  <?php echo $Name; ?>  to Bible Study Series</div></div><div class="messages"></div><div class="lesson" data-locale="en" style="background-image: url(assets/image4.jpg)"><div class="lesson__masthead"><div class="container"><span class="lesson__course-title"><?php echo $biblestudiesname; ?></span></div></div><div class="container"><div class="lesson__progress-bar"></div><div class="lesson__number"><div>Start<br>Page</div></div><div class="lesson__panel"><div class="lesson__step-body" align="center"><p><strong> <?php echo $dimg; ?> </strong><?php echo $info; ?><br><em>Author: <?php echo $author; ?></em>
</p></div></div></div><div class="d-flex align-items-center justify-content-center">
<a href="biblestudylesson.php?bibleId=<?php echo $bibleId;?>" class="lesson__button">Resume</a>
  </div></div></div><div class="footer"><div class="container"><p><span dir="ltr" lang="en">Copyright © Spring of Life Outreach Ministry<?php echo date("Y"); ?> &copy; All rights reserved.<a href="../aboutus.php">About Us</a>. <a href="../contactus.php">Contact Us</a></p><img alt="Voice of Prophecy logo" class="footer__logo" src="assets/logo-2.png" /></div></div><script src="assets/application-7e38db31cc29bf034c0774af155757398fe4a5f0486d0fede5f7acd0a4a8f9fb.js" data-turbolinks-track="reload"></script><script src="packs/js/application-c8f9e060f8f549723184.js"></script></body>
