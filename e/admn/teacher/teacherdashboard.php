...
<h6>You are welcome <?php echo $teachername;?> to Teachers Pannel</h6>
  ...
  <tr>
  <td width="194">&nbsp;</td>
    <td width="684"><h6><?php echo $rank;?></h6></td>
  </tr>
  <tr>
    <td>Name</td>
  ...
  <tr>
    ...
    <td><h6><?php echo $asp;?></h6></td>
  </tr>
  <tr>
    <td>Teacher Profile</td>
    <td><h6><?php echo $teacherprofile;?></h6></td>
  </tr>
</table>
...
<?php
 ...
 ?>
                      <tr>
                        ...
                        <td>
						<div class="col-auto">
                            <a href="addlessons2.php?CourseId=<?php echo $CourseId; ?>" class="btn btn-outline-secondary" onClick="return check_deletion()">Add Lessons</a>
                        </div>
						</td>
                      </tr>
					  <?php	} ?>
...
<li class="sidebar-menu-item">
						...
						<li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="viewstudent.php">
                                <span class="material-icons sidebar-menu-icon sidebar-menu-icon--left">school</span>
                                <span class="sidebar-menu-text">View students</span>
                            </a>
                        </li>
						<li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="viewstudentquestion.php">
                                <span class="material-icons sidebar-menu-icon sidebar-menu-icon--left">live_help</span>
                                <span class="sidebar-menu-text">Student Questions</span>
                            </a>
                        </li>
<li class="sidebar-menu-item">
