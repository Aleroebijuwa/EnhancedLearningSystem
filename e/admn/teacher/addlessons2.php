...
$sql = "INSERT INTO studies (sn,StudyId,CourseId,ItemId,moduleid,ItemTitle,ItemIntro,ContentType,ItemContent, date )
VALUES ('','$StudyId','$CourseId','$ItemId','$moduleid','$ItemTitle','$ItemIntro','$ContentType','$ItemContent', '$date')";
  ...
  <tr>
	...
	<td><h4></h4></td>
            ...
            <div class="container page__container page-section">
				...
				<div class="col-lg-8">
                <form method="post" action="addlessons2.php">
				<input name="CourseId" id="CourseId" type="hidden"  class="form-control" value="<?php echo $CourseId; ?>">
								<div class="form-group">
								<label class="form-label" for="name">Select Module:</label>
								<label for="moduleid"></label>
                            <select name="moduleid" class="form-control"  id="moduleid">
                            <?php  while ($rowb=mysqli_fetch_array($resultb)){
 echo "<option value='". $rowb['moduleid'] ."'>" .$rowb['modulename'] ."</option>"; }
	?>
                            </select>
							</div>
								<div class="form-group">
								<label class="form-label" for="name">Lessons:</label>
								<label for="StudyId"></label>
                            <select name="StudyId" class="form-control"  id="StudyId">
							 <option value="Study1">Lesson 1</option>
							 <option value="Study2">Lesson 2</option>
							 <option value="Study3">Lesson 3</option>
							 <option value="Study4">Lesson 4</option>
                            </select>
							</div>
							<div class="form-group">
                                    <label class="form-label" for="ItemTitle">Lesson Title:</label>
                                    <input name="ItemTitle" id="ItemTitle" type="text" class="form-control" placeholder="Lesson Title ...">
                                </div>
								<div class="form-group">
								<label class="form-label" for="ItemIntro">Lesson Introduction:</label>
                      <textarea name="ItemIntro" cols="60" rows="10" id="ItemIntro" class="form-control"></textarea>
					  </div>
					  <div class="form-group">
								<label class="form-label" for="name">Content Type:</label>
                            ...
                            <select name="ContentType" class="form-control"  id="ContentType">
							 ...
							 <option value="word">Word</option>
								...
								<input class="btn btn-primary" type="submit" name="submit" id="submit" value="Add Lesson">
