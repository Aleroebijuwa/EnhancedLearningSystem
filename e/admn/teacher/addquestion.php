...
<?php
	...
	?>
            ...
            <div class="card">
              <div class="card-body">
                <h6 class="card-title">Add Exam Question</h6>
	...
	//$report_file = $rowb['report_file']; ?>
                      <tr>
                        ...
                        <td>
						<div class="col-auto">
                            <a href="addquestion2.php?CourseId=<?php echo $CourseId; ?>" class="btn btn-outline-secondary" onClick="return check_deletion()">Add Question</a>
                        </div>
						</td>
                      </tr>
					  <?php	} ?>
