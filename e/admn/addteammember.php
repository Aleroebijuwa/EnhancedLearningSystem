...
$sql = "INSERT INTO team (Sn,rank,name,email,office,Courseimage,date)
VALUES ('','$rank','$name','$email','$office','$Courseimage','$date')";

if (mysqli_query($con, $sql)) {
  header('Location: '.'thankadminweb.php');
ob_end_flush();
}
}
?>
...
<h6>You are welcome <?php echo($_SESSION['usernames']);?> to Admin</h6>
                ...
                <div class="container page__container d-flex flex-column flex-md-row align-items-center text-center text-sm-left">
                    <div class="flex d-flex flex-column flex-sm-row align-items-center mb-24pt mb-md-0">
                        ...
                        <div class="mb-24pt mb-sm-0 mr-sm-24pt">
                            <h2 class="mb-0">Add Team Members</h2>
            ...
            <div class="container page__container page-section">
				...
				<div class="col-lg-8">
                <form method="post" action="addteammember.php" enctype="multipart/form-data">
                            ...
                            <select name="rank" class="form-control"  id="rank" >
							 ...
							 <option value="Elder(Dr.)">Elder(Dr.)</option>
								...
								<div class="form-group">
                                    <label class="form-label" for="name">Team Member's Name:</label>
                                    <input name="name" id="name" type="text" class="form-control" placeholder="Team Member's Name ...">
                                </div>
								<div class="form-group">
                                    <label class="form-label" for="email">Team Member's Email:</label>
                                    <input name="email" id="email" type="text" class="form-control" placeholder="Team Member's Email ...">
                                </div>
					  <div class="form-group">
                            ...
                            <select name="office" class="form-control"  id="office" >
							 ...
							 <option value="Treasurer">Treasurer</option>
								...
								<div class="form-group">
								  <label class="form-label" for="Courseimage">Team Member Image:</label><br>
                                  <input type="file" name="Courseimage" id="Courseimage"></td>
                                </div>
								<input class="btn btn-primary" type="submit" name="submit" id="submit" value="Add Team Member">
