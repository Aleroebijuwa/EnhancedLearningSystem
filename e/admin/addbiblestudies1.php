...
$sql = "INSERT INTO bible_studies (Sn,bibleid,biblestudiesname,Courseimage, date )
VALUES ('','$bibleid','$biblestudiesname','$Courseimage', '$date')";
...
<!-- Notifications dropdown -->
                ...
                <div class="container page__container d-flex flex-column flex-md-row align-items-center text-center text-sm-left">
                    <div class="flex d-flex flex-column flex-sm-row align-items-center mb-24pt mb-md-0">
                        ...
                        <div class="mb-24pt mb-sm-0 mr-sm-24pt">
                            <h2 class="mb-0">Bible Studies</h2>
            ...
            <div class="container page__container page-section">
				...
				<div class="col-lg-8">
                <form method="post" action="addbiblestudies.php">
								
							<div class="form-group">
                                    <label class="form-label" for="biblestudiesname">Bible Studies Name:</label>
                                    <input name="biblestudiesname" id="biblestudiesname" type="text" class="form-control" placeholder="Bible Studies Name ...">
                                </div>
								<div class="form-group">
								  <label class="form-label" for="Courseimage">Bible Studies Image:</label><br>
                                  <input type="file" name="Courseimage" id="Courseimage"></td>
                                </div>
								<input class="btn btn-primary" type="submit" name="submit" id="submit" value="Add Bible Studies">
