...
$queryb = "SELECT * FROM youth  WHERE regionid = '$regionid'";
...
<h6>You are welcome <?php echo($_SESSION['usernames']);?> to Admin</h6>
	...
	$cps = $cps +1;
	$youthid = $rowb['youthid'];
	$fname = $rowb['fname']; 
	$lname = $rowb['lname'];
	$email = $rowb['email'];
	$phone = $rowb['phone']; 
	$country = $rowb['country'];
	$date = $rowb['date'];
 ...
 ?>
                      <tr>
                        ...
                        <td>
						<div class="col-auto">
                            <a href="addyouthform1.php?youthid=<?php echo $youthid; ?>" class="btn btn-outline-secondary" onClick="return check_deletion()">Display Info</a>
