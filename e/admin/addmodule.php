...
///////////////////////////////////////
$query= "SELECT Sn FROM module order by Sn DESC";
...
$sql = "INSERT INTO module (sn,moduleid,modulename, date )
VALUES ('','$moduleid','$modulename', '$date')";
            ...
            <div class="container page__container page-section">
                ...
                <form method="post" action="addmodule.php">
							...
							<div class="form-group">
                                    ...
                                    <input name="modulename" id="modulename" type="text" class="form-control" placeholder="Module Name ...">
                                </div>
								<input class="btn btn-primary" type="submit" name="submit" id="submit" value="Add Module">
