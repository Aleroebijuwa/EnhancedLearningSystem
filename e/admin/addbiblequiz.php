...
$queryb= "SELECT * FROM biblelessons";
...
if (isset($_POST['submit'])){
   ...
   //Question query
   $query="insert into questions (bibleId,bstudyId,question_number, question) 
   	 values('$bibleId','$bstudyId','$question_number','$question_text')";
...
<h6>You are welcome <?php echo($_SESSION['usernames']);?> to Admin</h6>
	     ...
	     ?>
                <form method="post" action="addbiblequiz.php" enctype="multipart/form-data">
 ...
 echo "<option value='". $row['bstudyId'] ."'>" .$row['LessonsTitle'] ."</option>"; }
	?>
                            </select>
							</div>
								<div class="form-group">
                                    <label class="form-label" for="biblestudiesname">Question Number</label>
                                    <input name="question_number" id="question_number" type="text" class="form-control"value=" <?php echo $next; ?>">
                                </div>
								<div class="form-group">
                                    <label class="form-label" for="question_text">Question</label>
                                    <input name="question_text" id="question_text" type="text" class="form-control">
                                </div>
								<div class="form-group">
                                    <label class="form-label" for="choice1">Choice #1:</label>
                                    <input name="choice1" id="choice1" type="text" class="form-control">
                                </div>
								<div class="form-group">
                                    <label class="form-label" for="choice2">Choice #2:</label>
                                    <input name="choice2" id="choice2" type="text" class="form-control">
                                </div>
								<div class="form-group">
                                    <label class="form-label" for="choice3">Choice #3:</label>
                                    <input name="choice3" id="choice3" type="text" class="form-control">
                                </div>
								<div class="form-group">
                                    <label class="form-label" for="choice4">Choice #4:</label>
                                    <input name="choice4" id="choice4" type="text" class="form-control">
                                </div>
								<div class="form-group">
                                    <label class="form-label" for="correct_choice">Correct choice number:</label>
                                    <input name="correct_choice" id="correct_choice" type="number" class="form-control">
                                </div>
								<input class="btn btn-primary" type="submit" name="submit" id="submit" value="Add Bible Question">
