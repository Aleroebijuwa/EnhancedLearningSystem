...
$sql = "INSERT INTO faq (Sn,question,LessonsContect, date )
VALUES ('','$question','$LessonsContect', '$date')";
                ...
                <div class="container page__container d-flex flex-column flex-md-row align-items-center text-center text-sm-left">
                    <div class="flex d-flex flex-column flex-sm-row align-items-center mb-24pt mb-md-0">
                        ...
                        <div class="mb-24pt mb-sm-0 mr-sm-24pt">
                            <h2 class="mb-0">Add Question and Answer</h2>
            ...
            <div class="container page__container page-section">
                ...
                <form method="post" action="addfaq.php" enctype="multipart/form-data">
							...
							<div class="form-group">
                                    ...
                                    <input name="question" id="question" type="text" class="form-control" placeholder="Course Title ...">
                                </div>
					  <div class="form-group">
