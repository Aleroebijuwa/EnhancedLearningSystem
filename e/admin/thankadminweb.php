        ...
        <div class="mdk-header-layout__content page-content ">
            ...
            <div class="page-section">
                <div class="container page__container">
                    <form action="http://luma.humatheme.com/fixed-index.html" class="col-md-8 p-0 mx-auto">

                        <div class="list-group list-group-form mb-0">
                            <div class="list-group-item">
                                <fieldset role="group" aria-labelledby="label-type" class="m-0 form-group">
                                    <div class="form-row align-items-center">
                                        <label for="payment_cc" id="label-type" class="col-md-3 col-form-label form-label"> </label>
                                       <label class="col-form-label form-label col-sm-6"> Thank You for Adding a content</label>
                                    </div>
                            </div>
                            
                            
                            <div class="list-group-item text-center">
                                <a href="admindashboard.php" class="btn btn-primary">Add Another one</a>
                            </div>
                        </div>
