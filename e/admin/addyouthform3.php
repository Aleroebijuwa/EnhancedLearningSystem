...
$youthid = $_REQUEST['youthid'];
	
	$queryc = "SELECT* FROM youth WHERE youthid = '$youthid'"; 
...
$fname = $rowc['fname'];
$lname = $rowc['lname'];
$address1 = $rowc['address1'];
$address2 = $rowc['address2'];
$city = $rowc['city'];
$state = $rowc['state'];
...
$height = $rowc['height'];
$weight = $rowc['weight'];
$sinumber = $rowc['sinumber'];
$referred = $rowc['referred'];
$pnumber = $rowc['pnumber'];
$nametit = $rowc['nametit'];
$fname2 = $rowc['fname2'];
$lname2 = $rowc['lname2'];
$relationship = $rowc['relationship'];
$emergencycontact = $rowc['emergencycontact'];
$address3 = $rowc['address3'];
$address4 = $rowc['address4'];
$city2 = $rowc['city2'];
$state2 = $rowc['state2'];
$country2 = $rowc['country2'];
$zip2 = $rowc['zip2'];
$email2 = $rowc['email2'];
$phone2 = $rowc['phone2'];
$gender2 = $rowc['gender2'];
$title3 = $rowc['title3'];
$fname3 = $rowc['fname3'];
$lname3 = $rowc['lname3'];
$children = $rowc['children'];
$Spousephone = $rowc['Spousephone'];
$sinumber2 = $rowc['sinumber2'];
$referred2 = $rowc['referred2'];
$support = $rowc['support'];
$health = $rowc['health'];
$aids = $rowc['aids'];
$communicable = $rowc['communicable'];
$doctor = $rowc['doctor'];
$reasonvisit = $rowc['reasonvisit'];
$prescribed = $rowc['prescribed'];
$medication = $rowc['medication'];
$limitations = $rowc['limitations'];
$furtherinfo = $rowc['furtherinfo'];
$convicted = $rowc['convicted'];
$convictedcrime = $rowc['convictedcrime'];
$courtcases = $rowc['courtcases'];
$courtcases2 = $rowc['courtcases2'];
$christianorganization = $rowc['christianorganization'];
$enterprogram = $rowc['enterprogram'];
$ourprograms = $rowc['ourprograms'];
$ourprograms2 = $rowc['ourprograms2'];
$Preference = $rowc['Preference'];
$fluently = $rowc['fluently'];
$lastgrade = $rowc['lastgrade'];
$agree = $rowc['agree'];
$date = $rowc['date'];
?>
                ...
                <div class="container page__container d-flex flex-column flex-md-row align-items-center text-center text-sm-left">
                    <div class="flex d-flex flex-column flex-sm-row align-items-center mb-24pt mb-md-0">
                        ...
                        <div class="mb-24pt mb-sm-0 mr-sm-24pt">
                            <h2 class="mb-0">YOUTH EMPOWERMENT</h2>
...
<p><h5>What is the general condition of your health?: <font color="red"><?php echo $health; ?></font></h5></P>
<p><h5>Have you ever been treated for AIDS?: <font color="red"><?php echo $aids; ?></font></h5></P>
<p><h5>Have you recently had any communicable disease?: <font color="red"><?php echo $communicable; ?></font></h5></P>
<p><h5>Are you seeing a medical doctor for any reason?: <font color="red"><?php echo $doctor; ?></font></h5></P>
<p><h5>If "Yes" • give reason for visit: <font color="red"><?php echo $reasonvisit; ?></font></h5></P>
<p><h5>Are you presently taking any prescribed medication?: <font color="red"><?php echo $prescribed; ?></font></h5></P>
<p><h5>If "Yes" state the medication: <font color="red"><?php echo $medication; ?></font></h5></P>
<p><h5>Do you have any physical limitations that would hinder you doing normal manual labor?: <font color="red"><?php echo $limitations; ?></font></h5></P>
<p><h5>If "Yes" please give further information: <font color="red"><?php echo $furtherinfo; ?></font></h5></P>
<h3>Legal Information and Other</h3>
<p><h5>Have you ever been convicted for any crimes of violence?: <font color="red"><?php echo $convicted; ?></font></h5></P>
<p><h5>If 'Yes', give details: <font color="red"><?php echo $convictedcrime; ?></font></h5></P>
<p><h5>Do you have any court cases pending?: <font color="red"><?php echo $courtcases; ?></font></h5></P>
<p><h5>f 'Yes', give details: <font color="red"><?php echo $courtcases2; ?></font></h5></P>
<h3>Spiritual</h3>
<p><h5>Do you understand that Spring of Life is a Christian organization? <font color="red"><?php echo $christianorganization; ?></font></h5></P>
<p><h5>Why do you wish to enter this program? <font color="red"><?php echo $enterprogram; ?></font></h5></P>
<p><h5>Have you ever been in any of our programs previously? <font color="red"><?php echo $ourprograms; ?></font></h5></P>
<p><h5>If "Yes" what program and when did you attend?: <font color="red"><?php echo $ourprograms2; ?></font></h5></P>
<p><h5>Religious Preference or denomination: <font color="red"><?php echo $Preference; ?></font></h5></P>
<h3>Education Background</h3>
<p><h5>Do you fluently read, write and speak English? <font color="red"><?php echo $fluently; ?></font></h5></P>
<p><h5>Please state the last grade completed: <font color="red"><?php echo $lastgrade; ?></font></h5></P>

<p><a href="addyouthform2.php?youthid=<?php echo $youthid; ?>" class="btn btn-primary" onClick="return check_deletion()">Previous Page</a> </p>
