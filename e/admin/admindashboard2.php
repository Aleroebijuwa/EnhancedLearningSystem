            ...
            <div class="container page__container page-section">
                ...
                <table width="970" border="1" align="center" cellpadding="5" cellspacing="5" class="table" >
                          ...
                          <tr>
						   ...
						   <tr>
                            <td height="47" colspan="4" bgcolor="#303956" class="boldText"><h4><font color="#303956"></font><span class="btn-outline-secondary">Modules</span></td>
                          </tr>
                          <tr>
                            <td height="59" align="center"><b><br>
                              <a href="addmodule.php"><img src="icons/001-circle.png" width="64" height="64" /></a><br>
                              <a href="addmodule.php">Add</a> <br />
                              </a></b></td>
                            <td align="center"><b><br>
                              <a href="deletemodule.php"><img src="icons/009-close.png" width="64" height="64" /></a><br>
                              <a href="deletemodule.php">Delete </a> <br />
                            </b></td>
                            <td align="center"><b><br>
                              <a href="updatemodule.php"><img src="icons/011-arrows.png" width="64" height="64" /></a><br>
                              <a href="updatemodule.php">Update</a> <br />
                            </b></td>
                            <td align="center"><b><br>
                              <a href="displaymodule.php"><img src="icons/005-search.png" width="64" height="64" /></a><br>
                              <a href="displaymodule.php">Display</a> <br />
                            </b></td>
                          </tr>
						  <tr>
                          <td height="49" colspan="4" bgcolor="#CCCCCC"><h4><font color="#FFFFFF"></font><span class="c3-chart-arc">Teachers</span></h4></td>
                          </tr>
                          <tr>
...
<a href="addteacher.php"><img src="icons/006-people-1.png" width="64" height="64" /></a><br>
                          ...
                          <tr>
                            <td height="47" colspan="4" bgcolor="#303956" class="boldText"><h4><font color="#303956"></font><span class="btn-outline-secondary">Courses</span></td>
                          </tr>
                          <tr>
                            <td height="63" align="center"><b><br>
                              <a href="addcourses.php"><img src="icons/003-computer-1.png" width="64" height="64" /><br>
                              <a href="addcourses.php">Add</a> <br />
                            </b></td>
                            <td align="center"><b><br>
                              <a href="deletecourses.php"><img src="icons/008-interface.png" width="64" height="64" /><br>
                            ...
                            <td align="center"><b><br>
                              <a href="displaycourses.php"><img src="icons/002-business-1.png" width="64" height="64" /><br>
    ...
    <span class="sidebar-menu-text">Team Members</span>
                       ...
                       <li class="sidebar-menu-item">
                            ...
                            <ul class="sidebar-submenu collapse sm-indent" id="layouts_menu">
                                <li class="sidebar-menu-item">
                                    <a class="sidebar-menu-button" href="addmodule.php">
                                        <span class="sidebar-menu-text">Add Module</span>
                                    </a>
                                </li>
                                <li class="sidebar-menu-item">
                                    <a class="sidebar-menu-button" href="deletemodule.php">
                                        <span class="sidebar-menu-text">Delete Module</span>
                                    </a>
                                </li>
                                <li class="sidebar-menu-item">
                                    <a class="sidebar-menu-button" href="viewmodule.php">
                                        <span class="sidebar-menu-text">View Module</span>
                                    </a>
                                </li>
                                <li class="sidebar-menu-item">
                                    <a class="sidebar-menu-button" href="updatemodule.php">
                                        <span class="sidebar-menu-text">Edit Module</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                            ...
                            <ul class="sidebar-submenu collapse sm-indent" id="plugins_menu">
                                <li class="sidebar-menu-item">
                                    <a class="sidebar-menu-button" href="addbiblestudies.php">
                                        <span class="sidebar-menu-text">Add Bible Studies</span>
                                    </a>
                                </li>
                                <li class="sidebar-menu-item">
                                    <a class="sidebar-menu-button" href="deletebiblestudies.php">
                                        <span class="sidebar-menu-text">Delete Bible Studies</span>
                                    </a>
                                </li>
								<li class="sidebar-menu-item">
                                    <a class="sidebar-menu-button" href="displaybiblestudies.php">
                                        <span class="sidebar-menu-text">View Bible Studies</span>
                                    </a>
                                </li>
								<li class="sidebar-menu-item">
                                    <a class="sidebar-menu-button" href="updatebiblestudies.php">
                                        <span class="sidebar-menu-text">Update Bible Studies</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
