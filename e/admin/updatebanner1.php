...
$queryb = "SELECT * FROM banner WHERE Sn ='$Sn'";
...
<h6>You are welcome <?php echo($_SESSION['usernames']);?> to Admin</h6>
           ...
           <form method="post" action="updatebanner1.php" enctype="multipart/form-data">
								
								
							<input name="Sn" id="Sn" type="hidden"  class="form-control" value="<?php echo $Sn;?>">
								
								<div class="form-group">
								<label class="form-label" for="bannerinfo">Letter Information:</label>
                      <textarea name="bannerinfo" cols="60" rows="5" id="bannerinfo" class="form-control"><?php echo $bannerinfo;?></textarea>
					  </div>
								<div class="form-group">
