...
<h6>You are welcome <?php echo($_SESSION['usernames']);?> to Admin</h6>
                ...
                <div class="container page__container d-flex flex-column flex-md-row align-items-center text-center text-sm-left">
                    <div class="flex d-flex flex-column flex-sm-row align-items-center mb-24pt mb-md-0">
                        ...
                        <div class="mb-24pt mb-sm-0 mr-sm-24pt">
                            <h2 class="mb-0">Delete Banner</h2>
            ...
            <div class="container page__container page-section">
                ...
                <form method="post" action="addbanner.php" enctype="multipart/form-data">
                      ...
                      <textarea name="bannerinfo" cols="60" rows="5" id="bannerinfo" class="form-control"></textarea>
					  </div>
								<div class="form-group">
								  <label class="form-label" for="Courseimage">Banner Image:</label><br>
                                  <input type="file" name="Courseimage" id="Courseimage"></td>
                                </div>
								<input class="btn btn-primary" type="submit" name="submit" id="submit" value="Add Banner">
