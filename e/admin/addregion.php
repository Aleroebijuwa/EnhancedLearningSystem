...
$sql = "INSERT INTO region (regionid,regionname, date )
VALUES ('','$regionname', '$date')";
            ...
            <div class="container page__container page-section">
                ...
                <form method="post" action="addregion.php">
							...
							<div class="form-group">
                                    ...
                                    <input name="regionname" id="regionname" type="text" class="form-control" placeholder="Add Location ...">
                                </div>
								<input class="btn btn-primary" type="submit" name="submit" id="submit" value="Add Location">
