...
<h6>You are welcome <?php echo($_SESSION['usernames']);?> to Admin</h6>
			...
			<h3>Person to Contact in Case of Any Emergency</h3>			
<p><h5>Title:<font color="red"><?php echo $nametit; ?></font></h5></P>
<p><h5>Name: <font color="red"><?php echo $fname2; ?> <?php echo $lname2; ?></font></h5></P>
<p><h5>Relationship: <font color="red"><?php echo $relationship; ?></font></h5></P>
<p><h5>Emergency Contact Phone Number: <font color="red"><?php echo $emergencycontact; ?></font></h5></P>
<p><h5>Emergency Contact Address: <font color="red"><?php echo $address3; ?> <?php echo $address4; ?></font></h5></P>
<p><h5>City: <font color="red"><?php echo $city2; ?></font></h5></P>
<p><h5>State: <font color="red"><?php echo $state2; ?></font></h5></P>
<p><h5>Country: <font color="red"><?php echo $country2; ?></font></h5></P>
<p><h5>Zip Code: <font color="red"><?php echo $zip2; ?></font></h5></P>
<p><h5>Email Address: <font color="red"><?php echo $email2; ?></font></h5></P>
<p><h5>Phone number: <font color="red"><?php echo $phone2; ?></font></h5></P>
<p><h5>Marital Status: <font color="red"><?php echo $gender2; ?></font></h5></P>
<h3>Spouce's Name</h3>
<p><h5>Title: <font color="red"><?php echo $title3; ?></font></h5></P>
<p><h5>Name: <font color="red"><?php echo $fname3; ?> <?php echo $lname3; ?></font></h5></P>
<p><h5>Number of Children: <font color="red"><?php echo $children; ?></font></h5></P>
<p><h5>Spouse Phone Number: <font color="red"><?php echo $Spousephone; ?></font></h5></P>
<p><h5>Social Insurance Number: <font color="red"><?php echo $sinumber2; ?></font></h5></P>
<p><h5>Referee: <font color="red"><?php echo $referred2; ?></font></h5></P>
<p><h5>Does your spouse support you : <font color="red"><?php echo $support; ?></font></h5></P>
<p><a href="addyouthform1.php?youthid=<?php echo $youthid; ?>" class="btn btn-primary" onClick="return check_deletion()">Previous Page</a>  <a href="addyouthform3.php?youthid=<?php echo $youthid; ?>" class="btn btn-primary" onClick="return check_deletion()">Next Page</a></p></table>
