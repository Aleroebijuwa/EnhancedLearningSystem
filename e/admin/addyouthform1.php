...
<h6>You are welcome <?php echo($_SESSION['usernames']);?> to Admin</h6>
			...
			<table><tr><p><h5>Date: <font color="red"><?php echo $date; ?></font></h5></P><tr>
 <p><h5>Title:<font color="red"><?php echo $title; ?></font></h5></p>
<p> <h5>Name: <font color="red"><?php echo $lname; ?> <?php echo $fname; ?></font></h5></P>
<p><h5>Address: <font color="red"><?php echo $address1; ?> <?php echo $address2; ?></font></h5></P>
<p><h5>Town / City: <font color="red"> <?php echo $city; ?></font></h5></P>
<p><h5>State: <font color="red"><?php echo $state; ?></font></h5></P>
<p><h5>country: <font color="red"><?php echo $country; ?></font></h5></P>
<p><h5>Zip: <font color="red"><?php echo $zip; ?></font></h5></P>
<p><h5>Email: <font color="red"> <?php echo $email; ?></font></h5></P>
<p><h5>Phone Number: <font color="red"><?php echo $phone; ?></font></h5></P>
<p><h5>Gender <font color="red"> <?php echo $gender; ?></font></h5></P>
<p><h5>Date of Birth: <font color="red"><?php echo $dob; ?></font></h5></P>
<p><h5>Hight: <font color="red"><?php echo $height; ?></font></h5></P>
<p><h5>Weight:<font color="red"><?php echo $weight; ?></font></h5></P>
<p><h5>Social Insurance Number: <font color="red"><?php echo $sinumber; ?></font></h5></P>
<p><h5>Referee: <font color="red"><?php echo $referred; ?></font></h5></P>
<p><h5>Referee Phone Number: <font color="red"><?php echo $pnumber; ?></font></h5></P>
 <p><a href="addyouthform2.php?youthid=<?php echo $youthid; ?>" class="btn btn-primary" onClick="return check_deletion()">Next Page</a></p></table>
