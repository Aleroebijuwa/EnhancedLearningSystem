...
<h6>You are welcome <?php echo($_SESSION['usernames']);?> to Admin</h6>
	...
	$cps = $cps +1;
	$regionid = $rowb['regionid'];
	$regionname = $rowb['regionname']; 
	$date = $rowb['date'];
 ...
 ?>
                      <tr>
                        ...
                        <td>
						<div class="col-auto">
                            <a href="addyouthform.php?regionid=<?php echo $regionid; ?>" class="btn btn-outline-secondary" onClick="return check_deletion()">Display Youth Empowerment forms in this region</a>
