...
if (isset($_GET['bibleId']))
	{
		$bibleId = $_GET['bibleId'];
				
		$sql = "DELETE FROM bible_studies WHERE bibleId ='$bibleId'";
...
$queryb = "SELECT * FROM bible_studies";
...
<h6>You are welcome <?php echo($_SESSION['usernames']);?> to Admin</h6>
                ...
                <div class="container page__container d-flex flex-column flex-md-row align-items-center text-center text-sm-left">
                    <div class="flex d-flex flex-column flex-sm-row align-items-center mb-24pt mb-md-0">
                        ...
                        <div class="mb-24pt mb-sm-0 mr-sm-24pt">
                            <h2 class="mb-0">Delete Bible Studies</h2>
 ...
 ?>
                      <tr>
                        ...
                        <td><?php echo $biblestudiesname ?></td>
						<td><?php echo $author ?></td>
                        <td><?php echo $dimg ?></td>
                        <td><?php echo $date ?></td>
                        <td>
						<div class="col-auto">
                            <a href="deletebiblestudies.php?bibleId=<?=$rowb['bibleId']?>" class="btn btn-outline-secondary" onClick="return check_deletion()">Delete Bible Study</a>
