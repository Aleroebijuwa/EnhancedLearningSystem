...
$Sn = $_REQUEST['Sn'];
	...
	$queryc = "SELECT* FROM banner WHERE Sn = '$Sn'"; 
//"SELECT * FROM bible_studies  WHERE bibleId = '$bibleId'";
	...
	$img_file = "banner/".$Courseimage;

	$dimg = "<img src='$img_file' border='0'width='800px' height='520px'>";
	
	$dimg2 = "<img src='$img_file' border='0' width='40px' height='40px'>";
	
	$bannerinfo = $rowc['bannerinfo']; 
	$date = $rowc['date'];
?>
