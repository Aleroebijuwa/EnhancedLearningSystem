...
///////////////////////////////////////
$query= "SELECT Sn FROM teacher order by Sn DESC";
...
if(empty($lastid)){
	...
	$idd = str_replace('teacerh','',$lastid);
	$id =($idd+1);
	$number = 'teacher'.$id;
}
////////////////////////////////////
...
$sql = "INSERT INTO teacher (sn,teacherid,teachername, date )
VALUES ('','$teacherid','$teachername', '$date')";
            ...
            <div class="container page__container page-section">
                ...
                <form method="post" action="addteacher.php">
							...
							<div class="form-group">
                                    <label class="form-label" for="categoryname">Teacher Name:</label>
                                    <input name="teachername" id="teachername" type="text" class="form-control" placeholder="Teacher's Name ...">
                                </div>
								<input class="btn btn-primary" type="submit" name="submit" id="submit" value="Add Teacher">
