...
$queryb = "SELECT * FROM banner WHERE bibleId ='$bibleId'";
...
$filenameCourseimage = 'banner/'. $Courseimage;
...
$sql="UPDATE `banner` SET `bannerinfo` = '$bannerinfo',`Courseimage` = '$Courseimage', `date` = '$date' WHERE `banner`.`Sn` = '$Sn'";
//echo $sql;
...
<h6>You are welcome <?php echo($_SESSION['usernames']);?> to Admin</h6>
           ...
           <form method="post" action="updatebiblestudies1.php" enctype="multipart/form-data">
								
								
							<input name="Sn" id="bibleId" type="hidden"  class="form-control" value="<?php echo $bibleId;?>">
								
								<div class="form-group">
								<label class="form-label" for="biblestudiesname">Bible Studies Name:</label>
                      <textarea name="biblestudiesname" cols="60" rows="5" id="biblestudiesname" class="form-control"><?php echo $biblestudiesname;?></textarea>
					  </div>
					  
					  <div class="form-group">
								<label class="form-label" for="author">Author:</label>
                      <textarea name="author" cols="60" rows="5" id="author" class="form-control"><?php echo $author;?></textarea>
					  </div>
					  
					  <div class="form-group">
								<label class="form-label" for="info">Information About Bible Study:</label>
                      <textarea name="info" cols="60" rows="5" id="info" class="form-control"><?php echo $info;?></textarea>
					  </div>
					  
								<div class="form-group">
								  <label class="form-label" for="Courseimage">Bible study Image:</label><br>
