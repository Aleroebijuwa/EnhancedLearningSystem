...
$queryb = "SELECT * FROM team WHERE Sn ='$Sn'";
...
$filenameCourseimage = 'team/'. $Courseimage;
...
//$sql = "INSERT INTO banner (Sn,bannerinfo,Courseimage,date)
//VALUES ('','$bannerinfo','$Courseimage','$date')";
$sql="UPDATE `team` SET `rank` = '$rank',`name` = '$name',`office` = '$office',`Courseimage` = '$Courseimage', `date` = '$date' WHERE `team`.`Sn` = '$Sn'";
//echo $sql;

if (mysqli_query($con, $sql)) {
header('Location: '.'updateteammember.php');
ob_end_flush();
}
}
...
<h6>You are welcome <?php echo($_SESSION['usernames']);?> to Admin</h6>
                ...
                <div class="container page__container d-flex flex-column flex-md-row align-items-center text-center text-sm-left">
                    <div class="flex d-flex flex-column flex-sm-row align-items-center mb-24pt mb-md-0">
                        ...
                        <div class="mb-24pt mb-sm-0 mr-sm-24pt">
                            <h2 class="mb-0">Update Banner</h2>
           ...
           <form method="post" action="updateammember1.php" enctype="multipart/form-data">
								
								
							<input name="Sn" id="Sn" type="hidden"  class="form-control" value="<?php echo $Sn;?>">
                            ...
                            <select name="rank" class="form-control"  id="rank" >
							 ...
							 <option value="Pastor(Prof.)">Pastor(Prof.)</option>
							 <option value="Pastor(Dr.)">Pastor(Dr.)</option>
							 <option value="Elder">Elder</option>
							 <option value="Elder(Prof.)">Elder(Prof.)</option>
							 <option value="Elder(Dr.)">Elder(Dr.)</option>
								...
								<div class="form-group">
                                    ...
                                    <input name="name" id="name" type="text" class="form-control" value="<?php echo $name;?>" placeholder="Team Member Name ...">
                                </div>
					  <div class="form-group">
                            ...
                            <select name="office" class="form-control"  id="office" >
							 ...
							 <option value="Executive / Financial Secretary">Executive / Financial Secretary</option>
							 <option value="Evangelism & Spiritual Director">Evangelism & Spiritual Director</option>
							 <option value="Project Director /<br><br><br><br><br><br><br><br> Liaison Officer">Project Director / Liaison Officer</option>
							 <option value="Treasurer">Treasurer</option>
								...
								<div class="form-group">
								  <label class="form-label" for="Courseimage">Banner Image:</label><br>
                                  <input type="file" name="Courseimage" id="Courseimage" value="<?php echo $Courseimage;?>" ><?php echo $Courseimage;?></td>
                                </div>
								<input class="btn btn-primary" type="submit" name="submit" id="submit" value="update Banner">
