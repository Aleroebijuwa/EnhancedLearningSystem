...
//////////////////////////////////////
$query= "SELECT Sn FROM courselist order by Sn DESC";
...
$sql = "INSERT INTO courselist (Sn,CourseId ,teacherid,level,CourseTitle,CourseDis,Courseimage,date )
VALUES ('','$CourseId','$teacherid','$level','$CourseTitle','$CourseDis','$Courseimage','$date')";
...
<h6>You are welcome <?php echo($_SESSION['usernames']);?> to Admin</h6>
            ...
            <div class="container page__container page-section">
				...
				<div class="col-lg-8">
                <form method="post" action="addcourses.php" enctype="multipart/form-data">
 ...
 echo "<option value='". $row['teacherid'] ."'>" .$row['teachername'] ."</option>"; }
	?>
							...
							<div class="form-group">
								<label class="form-label" for="name"> Class Stages:</label>
								<label for="level"></label>
                            <select name="level" class="form-control"  id="level">
							 <option value="-">-</option>
							 <option value="-">Stage1</option>
							 <option value="-">Stage2</option>
							 <option value="-">Stage3</option>
							 <option value="-">Stage4</option>
                
                            </select>
							</div>
							<div class="form-group">
                                    <label class="form-label" for="CourseTitle">Course Title:</label>
                                    <input name="CourseTitle" id="CourseTitle" type="text" class="form-control" placeholder="Course Title ...">
                                </div>
								<div class="form-group">
								<label class="form-label" for="CourseDis">Course Image:</label>
                      <textarea name="CourseDis" cols="60" rows="10" id="CourseDis" class="form-control"></textarea>
					  </div>
								<div class="form-group">
								  <label class="form-label" for="Courseimage">Course Image:</label><br>
