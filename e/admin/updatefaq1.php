...
$queryb = "SELECT * FROM faq WHERE Sn ='$Sn'";
	...
	$LessonsContect =  $rowb['LessonsContect'];
...
$sql="UPDATE `faq` SET `question` = '$question',`LessonsContect` = '$LessonsContect', `date` = '$date' WHERE `faq`.`Sn` = '$Sn'";
//echo $sql;

if (mysqli_query($con, $sql)) {
header('Location: '.'updatefaq.php');
ob_end_flush();
}
}
...
<h6>You are welcome <?php echo($_SESSION['usernames']);?> to Admin</h6>
            ...
            <div class="container page__container page-section">
				...
				<div class="col-lg-10">
                <form method="post" action="updatefaq1.php" enctype="multipart/form-data">
								
							<input name="Sn" id="Sn" type="hidden"  class="form-control" value="<?php echo $Sn;?>">	
							
							<div class="form-group">
                                    <label class="form-label" for="question">Question:</label>
                                    <input name="question" id="question" type="text" class="form-control" value="<?php echo $question;?>" placeholder="Course Title ...">
                                </div>
					  <div class="form-group">
								<label class="form-label" for="LessonsContect">Answer:</label>
                      <textarea name="LessonsContect" cols="60" rows="10" id="LessonsContect" class="form-control"><?php echo $LessonsContect;?></textarea>
					  </div>
					  
								
								<input class="btn btn-primary" type="submit" name="submit" id="submit" value="Add Question and Answer">
