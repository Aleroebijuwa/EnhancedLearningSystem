...
<h6>You are welcome <?php echo($_SESSION['usernames']);?> to Admin</h6>
 ...
 ?>
                      <tr>
                        ...
                        <td>
						<div class="col-auto">
                            <a href="deleteregion.php?regionid=<?=$rowb['regionid']?>" class="btn btn-outline-secondary" onClick="return check_deletion()">Delete Location</a>
