...
if (isset($_GET['Sn']))
	{
		...
		$sql = "DELETE FROM contact WHERE Sn ='$Sn'";
...
<h6>You are welcome <?php echo($_SESSION['usernames']);?> to Admin</h6>
 ...
 ?>
                      <tr>
                        ...
                        <td>
						<div class="col-auto">
                            <a href="contact.php?Sn=<?=$rowb['Sn']?>" class="btn btn-outline-secondary" onClick="return check_deletion()">Delete Team Member</a>
