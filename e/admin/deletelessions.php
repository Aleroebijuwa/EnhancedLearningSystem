...
if (isset($_GET['ItemId']))
	{
		...
		$sql = "DELETE FROM biblelessons WHERE ItemId ='$ItemId'";
...
<h6>You are welcome <?php echo($_SESSION['usernames']);?> to Admin</h6>
 ...
 ?>
                      <tr>
                        ...
                        <td><?php echo $LessonsTitle ?></td>
                        <td><?php echo $date ?></td>
                        <td>
						<div class="col-auto">
                            <a href="deletelessions.php?ItemId=<?=$rowb['ItemId']?>" class="btn btn-outline-secondary" onClick="return check_deletion()">Delete Bible Study</a>
