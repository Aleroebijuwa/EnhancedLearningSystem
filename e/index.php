            ...
            <div class="mdk-header__content justify-content-center">
                ...
                <div class="navbar navbar-expand navbar-dark-dodger-blue bg-transparent will-fade-background" id="default-navbar" data-primary>
                    ...
                    <ul class="nav navbar-nav ml-auto mr-0">
                        <li class="nav-item">
                            <a href="../index.php" class="nav-link" data-toggle="tooltip" data-title="website Home Page" data-placement="bottom" data-boundary="window"><i class="material-icons">home</i></a>
                       
                            <a href="../index.php" class="btn btn-outline-white">Back to website Home Page</a>
                        </li>
                    </ul>
                </div>

                <div class="hero container page__container text-center text-md-left py-112pt">
                    <h1 class="text-white text-shadow">You are Welcome  </h1>
                    <p class="lead measure-hero-lead mx-auto mx-md-0 text-white text-shadow mb-48pt">Spring of Life Outreach Ministry: Bible Study and Mission Institute<br> Click on any of the button to enrol in the Bible Study or Mission School</p>

                    <a href="school/index.php" class="btn btn-lg btn-white btn--raised mb-16pt">Mission School</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="bibleindex.php" class="btn btn-lg btn-white btn--raised mb-16pt">Bible Study Serise</a>
