...
$query = "SELECT * FROM forumreg WHERE Name ='$name' AND Phone = '$phone' AND Email = '$email'";
...
$querye = "INSERT INTO forumreg VALUES ('','$name', '$email', '$phone', '$username', '$password')";
...
echo 'Membership registration Successful <a href="login.php">Continue to login</a>';
//header("location: admin.php");


}
else{
echo 'Existing User  <a href="login.php">Continue to login</a>';
        ...
        <div class="leftpanel">
            <div class="media profile-left">
                ...
                <div class="media-body">
                    <h4 class="media-heading">Mr Thankgod </h4>
        ...
        <div class="mainpanel">
                ...
                <div class="media">
                    ...
                    <div class="media-body">
                        <ul class="breadcrumb">
                            ...
                            <li><a href="superadmin.html">Forum Membership</a></li>
                            <li>Join Forum</li>
                        </ul>
            ...
            <div class="contentpanel">
                <div class="panel panel-babcock">
                    <div  class="panel-heading">Forum Membership Registration
